    ...
    try:
        ...
        result = db.execute(text("""
            ...
            SET workflow_id = 'af000001-0000-0000-0000-000000000005',
                config      = config || CAST('{"oms_app_key":"REDACTED","oms_app_secret":"REDACTED","oms_wh_code":"DE19713"}' AS jsonb)
        ...
        db.execute(text("""
            ...
            VALUES (
                ...
                'a1b2c3d4-0003-0000-0000-000000000003',
                'af000001-0000-0000-0000-000000000005',
                CAST('{"ydd_api_key":"REDACTED","ydd_cust_id":"REDACTED","ydd_channel_id":"Fedex home delivery 洛杉矶渠道","oms_app_key":"REDACTED","oms_app_secret":"REDACTED","oms_wh_code":"DE19713"}' AS jsonb)
            )
