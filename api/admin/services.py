...
# Role->service permission grants used to live here, scoped per group
# (group_service_role). They're now global -- see api/admin/roles.py's
# /admin/roles/{role_id}/services/* endpoints and
# models.role.RoleServicePermission's docstring for why.
