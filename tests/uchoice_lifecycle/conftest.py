"""Isolation guards for the offline U-Choice lifecycle regression suite."""
...
# Application imports validate configuration eagerly. These inert values let
...
def block_operational_clients(monkeypatch):
    """Fail loudly if an offline test reaches an operational integration."""
